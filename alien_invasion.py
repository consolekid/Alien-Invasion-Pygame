...
class AlienInvasion:
    ...
    def _update_bullets(self):
        ...
        if not self.aliens:
            #Destroy existing bullet and create a new fleet
            self.bullets.empty()
            self._create_fleet()
    ...
    def _create_fleet(self):
        ...
        #create a fleet and find the number of aliens in a row.
    ...
    def _check_fleet_edges(self):
        """Respond appropriatley if aliens have reached an edge"""
